...
extern "C" int rgbMatrixInit(int rows, int chain, int parallel)
{
  if (!io.Init())
    return 0;
...
extern "C" void rgbMatrixClose()
{
  canvas_->Clear();
  delete canvas_;
}

extern "C" void rgbMatrixSetPixel(int x, int y,
                        uint8_t red, uint8_t green, uint8_t blue)
{
  canvas_->SetPixel(y, x, red, green, blue);
}
...
extern void rgbMatrixClose(void);

extern void rgbMatrixSetPixel(int x, int y,
                        uint8_t red, uint8_t green, uint8_t blue);

extern void rgbMatrixFill(uint8_t red, uint8_t green, uint8_t blue);

extern void rgbMatrixClear(void);

extern int rgbMatrixWidth(void);

extern rgbMatrixHeight(void);
